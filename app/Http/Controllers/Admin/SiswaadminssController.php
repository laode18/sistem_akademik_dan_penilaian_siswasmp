...
class SiswaadminssController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.siswaadminss', compact('siswas', 'kelas', 'ss', 'datas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        //redirect dengan pesan sukses
            return redirect()->route('datasiswaadminss')->with(['success' => 'Data Saved Successfully!']);
        }else{
        //redirect dengan pesan error
            return redirect()->route('datasiswaadminss')->with(['error' => 'Data Save Failed!']);
        }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('/datasiswaadminkelas9')->with(['success' => 'Data Updated Successfully!']);
    }
    ...
    public function destroy($id_siswa)
    {
        ...
        return redirect ('/datasiswaadminkelas9')->with(['success' => 'Data Deleted Successfully!']);
    }
}