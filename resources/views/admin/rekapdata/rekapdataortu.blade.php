                ...
                <div class="modal-dialog modal-lg modal-center">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="serviceModalLabel">Download Data Orang Tua</h5>
                        ...
                        <div class="modal-body" style="margin-left: -15px;">
                            ...
                            <center>
                              ...
                              <div style="margin-top: 30px; text-align: center; color: black;">
                                ...
                                <p style="margin: 5px 0; font-size: 11pt;"><b>DATA REKAP ORANG TUA</b></p>
                            ...
                            <div style="margin-top: 30px; padding-left: 60px; padding-right: 60px;"> 
                              ...
                              <table id="data-table" class="table text-start align-middle table-bordered table-hover mb-0" style="width: 100%; font-size: 11pt; line-height: 25px; border-collapse: collapse;">
                                  <thead>
                                    ...
                                    <th scope="col" style="text-align: center; vertical-align: middle; color: white;">Nam Orang Tua</th>
                                    <th scope="col" style="text-align: center; vertical-align: middle; color: white;">Nama Anak/Siswa</th>
                                    <th scope="col" style="text-align: center; vertical-align: middle; color: white;">Alamat</th>
                                </tr>
                            </thead>
                            <tbody>
                              <?php $np=1; ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#download-button').click(function() {
            ...
            a.href = url;
            a.download = 'rekapdataorangtua.csv';
