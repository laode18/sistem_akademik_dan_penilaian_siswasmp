                ...
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div>
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                            <?php $no = 1; ?>
                            @foreach($siswass as $sw)
                                <tr class="text-center">
                                    <td>{{$no++}}.</td>
                                    <td>{{ $sw->nisn }}</td>
                                    <td style="vertical-align: middle; text-align: center;">
                                        <img src="{{ url('images/'.$sw->foto) }}" class="img-thumbnail" width="50" height="50">
                                    </td>
                                    <td>{{ $sw->nama_siswa }}</td>
                                    <td>{{ $sw->jenis_kel }}</td>
                                    <td>{{ $sw->nama_kelas }}</td>
            ...
            <div class="modal fade" id="datasiswaModal" tabindex="-1" aria-labelledby="serviceModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-center">
                    <div class="modal-content">
                        ...
                        <h5 class="modal-title" id="serviceModalLabel">Download Data Siswa</h5>
                        ...
                        <div class="modal-body" style="margin-left: -15px;">
                            ...
                            <center>
                              ...
                              <div style="margin-top: 30px; text-align: center; color: black;">
                                ...
                                <p style="margin: 5px 0; font-size: 11pt;"><b>DATA REKAP SISWA KELAS {{ $siswass[0]->nama_kelas }}</b></p>
                            ...
                            <div style="margin-top: 30px; padding-left: 60px; padding-right: 60px;"> 
                              ...
                              <table id="data-table" class="table text-start align-middle table-bordered table-hover mb-0" style="width: 100%; font-size: 11pt; line-height: 25px; border-collapse: collapse;">
                                  <thead>
                                    ...
                                    <th scope="col" style="text-align: center; vertical-align: middle; color: white;">NISN</th>
                                    <th scope="col" style="text-align: center; vertical-align: middle; color: white;">Foto</th>
                                    <th scope="col" style="text-align: center; vertical-align: middle; color: white;">Nama Siswa</th>
                                    <th scope="col" style="text-align: center; vertical-align: middle; color: white;">Jenis Kelamin</th>
                                    <th scope="col" style="text-align: center; vertical-align: middle; color: white;">Tanggal Lahir</th>
                                </tr>
                            </thead>
                            <tbody>
                              <?php $np=1; ?>
