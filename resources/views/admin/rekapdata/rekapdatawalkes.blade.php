                            ...
                            @foreach ($walkes as $wk)
                                <tr class="text-center">
                                    ...
                                    <td style="vertical-align: middle; text-align: center;">
                                        <img src="{{ url('images/'.$wk->foto) }}" class="img-thumbnail" width="50" height="50">
                                    </td>
                ...
                <div class="modal-dialog modal-lg modal-center">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="serviceModalLabel">Download Data Wali Kelas</h5>
                        ...
                        <div class="modal-body" style="margin-left: -15px;">
                            ...
                            <center>
                              ...
                              <div style="margin-top: 30px; text-align: center; color: black;">
                                ...
                                <p style="margin: 5px 0; font-size: 11pt;"><b>DATA REKAP WALI KELAS</b></p>
                            ...
                            <div style="margin-top: 30px; padding-left: 60px; padding-right: 60px;"> 
                              ...
                              <table id="data-table" class="table text-start align-middle table-bordered table-hover mb-0" style="width: 100%; font-size: 11pt; line-height: 25px; border-collapse: collapse;">
                                  <thead>
                                    ...
                                    <th scope="col" style="text-align: center; vertical-align: middle; color: white;">Email</th>
...
<script>
    $(document).ready(function() {
        ...
        $('#download-button').click(function() {
            ...
            a.href = url;
            a.download = 'rekapdatawalikelas.csv';
