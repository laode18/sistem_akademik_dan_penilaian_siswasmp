...
<div class="container-fluid pt-4 px-4">
    ...
    <h4>Rekap Data Nilai {{ $filteredAbsensiss[0]->nama_matpel }} Kelas {{ $filteredAbsensiss[0]->nama_kelas }}</h4>
@else
                    ...
                    <table class="table text-start align-middle table-bordered table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>{{ $filteredAb->ulangan_harian }}</td>
                                <td>{{ $filteredAb->tugas }}</td>
                                <td>{{ $filteredAb->uts }}</td>
                                <td>{{ $filteredAb->uas }}</td>
                                <td>{{ $filteredAb->nilai_absen }}</td>
                                <?php
                                $rata_nilai = ($filteredAb->ulangan_harian + $filteredAb->tugas + $filteredAb->uts + $filteredAb->uas + $filteredAb->nilai_absen) / 5;
                                ?>
                                <td>{{ $rata_nilai }}</td>
                            </tr>
                            @endforeach
        ...
        <div class="modal-dialog modal-lg modal-center">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="serviceModalLabel">Download Data Nilai Siswa</h5>
                ...
                <div class="modal-body" style="margin-left: -15px;">
                    ...
                    <center>
                      ...
                      <div style="margin-top: 30px; text-align: center; color: black;">
                        @if(count($filteredAbsensiss) > 0)
                        <p style="margin: 5px 0; font-size: 11pt;"><b>DATA REKAP NILAI {{ strtoupper($filteredAbsensiss[0]->nama_matpel) }} KELAS {{ strtoupper($filteredAbsensiss[0]->nama_kelas) }}</b></p>
                        @else
                        <p>Tidak ada data yang ditemukan.</p>
                        @endif
                    ...
                    <div style="margin-top: 30px; padding-left: 60px; padding-right: 60px;"> 
                        ...
                        <table id="data-table" class="table text-start align-middle table-bordered table-hover mb-0" style="width: 100%; font-size: 11pt; line-height: 25px; border-collapse: collapse;">
                          <thead>
                            ...
                            <th scope="col" style="text-align: center; color: white;">Nama Siswa</th>
                            <th scope="col" style="text-align: center; color: white;">Ulangan Harian</th>
                            <th scope="col" style="text-align: center; color: white;">Tugas</th>
                            <th scope="col" style="text-align: center; color: white;">UTS</th>
                            <th scope="col" style="text-align: center; color: white;">UAS</th>
                            <th scope="col" style="text-align: center; color: white;">Absensi</th>
